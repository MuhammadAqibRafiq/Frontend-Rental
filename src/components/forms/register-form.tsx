...
export function RegisterForm() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-2xl font-bold text-[#1a0f3c]">Create your account</h1>
        <p className="text-sm text-[#7c6fa0] mt-1">Free for the first 3 properties. No card required to start.</p>
      </div>
      ...
      */}
      ...
      <p className="text-center text-sm text-[#7c6fa0]">
        ...
        <Link href={routes.login} className="font-semibold text-[#7c3aed] hover:underline">
          Sign in
        </Link>
      </p>
    </div>
